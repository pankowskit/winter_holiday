...
class MenuS5 extends Component{
    render(){
        return(    
            <Container fluid className="menu-s5 bg-dark d-flex minh-25vh align-items-center py-5 border-top border-dark">
